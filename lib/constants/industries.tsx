...
export const INDUSTRIES: Industry[] = [
  {
    ...
    icon: <TruckIcon className="w-5 h-5 text-current" />,
  ...
  },
  {
    ...
    icon: <HeartIcon className="w-5 h-5 text-current" />,
  ...
  },
  {
    ...
    icon: <BuildingOffice2Icon className="w-5 h-5 text-current" />,
  ...
  },
  {
    ...
    icon: <CurrencyDollarIcon className="w-5 h-5 text-current" />,
    href: "/blog/fintech",
    colSpan:  6,
  },
]
