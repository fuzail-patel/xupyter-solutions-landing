...
export const pageSEO: Record<string, Metadata> = {
  home: {
    title: "Custom Business Systems & Web Platforms",
    description:
      "We design and build scalable SaaS platforms, internal tools, and complex web systems for growing companies.",
  },
  services: {
  ...
  about: {
    title: "Architecture-Driven Systems & Long-Term Scaling",
    description:
      "We design and build scalable business systems engineered for long-term operational clarity.",
  },
  contact: {
