...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_jobs_type" AS ENUM('full-time', 'contract', 'remote');
  CREATE TYPE "public"."enum_jobs_status" AS ENUM('open', 'closed');
  CREATE TYPE "public"."enum_testimonials_type" AS ENUM('text', 'video');
  CREATE TYPE "public"."enum_contact_leads_status" AS ENUM('new', 'contacted', 'resolved');
  CREATE TYPE "public"."enum_contact_leads_email_status" AS ENUM('pending', 'sent', 'failed');
  ...
  CREATE TABLE "contact_leads" (
  	...
  	"status" "enum_contact_leads_status" DEFAULT 'new',
  	"is_quote" boolean DEFAULT false,
  	"company_size" varchar,
  	"budget_range" varchar,
  	"service_slug" varchar,
  	"email_status" "enum_contact_leads_email_status" DEFAULT 'pending',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "testimonials" ADD CONSTRAINT "testimonials_video_thumbnail_id_media_id_fk" FOREIGN KEY ("video_thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "testimonials_video_thumbnail_idx" ON "testimonials" USING btree ("video_thumbnail_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_contact_leads_email_status";`)
}
