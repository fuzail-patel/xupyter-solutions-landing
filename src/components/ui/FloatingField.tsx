...
import type { FloatingFieldProps } from "@/types/ui"

export default function FloatingField({ id, label, children, ...props }: FloatingFieldProps & React.HTMLAttributes<HTMLDivElement>) {
  return (
