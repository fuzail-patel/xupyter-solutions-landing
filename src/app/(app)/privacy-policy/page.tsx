...
import { PRIVACY_POLICY_SECTIONS } from "@/lib/constants/privacy-policy"
  ...
  return (
    <main className="flex flex-col bg-background">
      <PageHeader
        ...
        titleSecondary="Policy"
        description={`Last updated: ${lastUpdated}. This policy outlines how we handle your data.`}
      />
                  ...
                  {section.subSections && (
                    <div className="space-y-6 mt-8 ps-3">
                      {section.subSections.map((sub) => (
                        <div key={sub.id} id={sub.id} className="p-8 bg-card border-l-5 border-border/60">
