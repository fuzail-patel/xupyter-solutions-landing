    ...
    <main className="flex flex-col">
      ...
      <section className="py-10 sm:py-12 md:py-14">
        <div className="max-w-7xl mx-auto px-6 space-y-10 md:space-y-12">
          <div className="group overflow-hidden rounded-2xl border border-border/70 bg-card shadow-[0_18px_40px_rgba(15,23,42,0.08)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_26px_70px_rgba(15,23,42,0.18)]">
              ...
              <div className="flex flex-col justify-between gap-6 p-6 lg:py-8">
                <div className="space-y-4 space-x-2">
                  {featuredProject.featured && (
                    <span className="inline-flex items-center rounded-full border border-amber-500/60 bg-amber-500/10 px-3 py-1 text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-amber-500">
                      Featured
                    </span>
                  )}
